...
export default function SiteHeader() {
  ...
  return (
    <header className="relative z-10 bg-white shadow-md border-b">
      ...
      <div
        className={`md:hidden absolute inset-x-0 top-full z-60 transform transition-all duration-300 ease-in-out ${mobileNavOpen ? 'translate-y-0 opacity-100 pointer-events-auto' : '-translate-y-4 opacity-0 pointer-events-none'}`}
