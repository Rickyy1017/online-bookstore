...
export default function SiteHeader() {
  ...
  return (
    <header className="relative z-10 bg-white shadow-md border-b">
      ...
      <div
        className={`md:hidden fixed inset-x-0 top-0 z-50 transform transition-all duration-300 ease-in-out ${mobileNavOpen ? 'translate-y-0 opacity-100 pointer-events-auto' : '-translate-y-full opacity-0 pointer-events-none'}`}
