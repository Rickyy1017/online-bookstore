...
export default function SiteHeader() {
  ...
  return (
    <header className="relative z-10 bg-white shadow-md border-b">
      ...
      {/* Panel (fixed so it doesn't push content) */}
      <div
        className={`md:hidden fixed left-0 right-0 top-16 z-50 transform transition-transform duration-300 ${mobileNavOpen ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0 pointer-events-none'}`}
