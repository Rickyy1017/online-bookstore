  ...
  return (
    <>
      ...
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-8">
        <div className="bg-gray-800 shadow-lg rounded-lg p-4 hover:shadow-xl transition-shadow border border-gray-700">
          <Image src="/images/rep.jpg" alt="REPOSITION OF CHRIST" width={180} height={270} className="mx-auto mb-4 rounded shadow-md" />
          <h3 className="text-lg font-bold text-white mb-2 text-center">REPOSITION OF CHRIST</h3>
          <p className="text-gray-400 text-sm text-center mb-3"><b>Author:</b> Nathaneil C.U.Okoro</p>
          <div className="text-center mb-4">
            <p className="text-gray-300 text-sm">Soft Copy: ₦1000</p>
            <p className="text-gray-300 text-sm">Hard Copy: ₦1700</p>
          </div>
          <div className="flex gap-2 mb-3">
            <button onClick={() => addToCart('REPOSITION OF CHRIST', 1000, 'Soft Copy')} className="bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 flex-1 text-sm">Soft Copy</button>
            <button onClick={() => addToCart('REPOSITION OF CHRIST', 1700, 'Hard Copy')} className="bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 flex-1 text-sm">Hard Copy</button>
          </div>
