...
export default function Page() {
  ...
  const handleInfoSubmit = async () => {
    ...
    window.open(`mailto:ericjo6303@gmail.com?subject=New Contact&body=${encodeURIComponent(message)}`);

    // Send WhatsApp message
    window.open(`https://wa.me/2349138246303?text=${encodeURIComponent(message)}`);

    alert('Information submitted successfully! Email and WhatsApp opened with your details.');
