      ...
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-8">
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => addToCart('REPOSITION OF CHRIST', 1700, 'Hard Copy')} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 flex-1">Buy Hard Copy</button>
          </div>
        </div>
