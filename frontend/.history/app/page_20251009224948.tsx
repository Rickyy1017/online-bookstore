      ...
      {isBannerVisible && (
        <div className="bg-indigo-700 text-white text-sm py-2">
          <div className="container mx-auto flex items-center justify-center gap-4">
            <Link href="/donate" className="underline">Make a Donation Now</Link>
            <span>|</span>
            <Link href="/buy" className="underline">Buy Now</Link>
          </div>
        </div>
      )}

      <header className="container mx-auto py-8 px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Image src="/logo.png" alt="logo" width={90} height={90} className="rounded" />
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold">UNUSUAL USUAL MAN</h1>
            <p className="text-lg text-slate-600">Online Bookstore</p>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <nav className="hidden md:flex gap-3">
            <Link href="/" className="px-3 py-1 rounded hover:bg-indigo-50">Home</Link>
            <Link href="/services" className="px-3 py-1 rounded hover:bg-indigo-50">Services</Link>
            <Link href="/humanitarian-initiative" className="px-3 py-1 rounded hover:bg-indigo-50">Humanitarian Initiative</Link>
            <Link href="/about" className="px-3 py-1 rounded hover:bg-indigo-50">About Us</Link>
            <Link href="/contact" className="px-3 py-1 rounded hover:bg-indigo-50">Contact</Link>
          </nav>

          <button onClick={viewCart} aria-label="Open cart" className="bg-indigo-600 text-white px-4 py-2 rounded flex items-center gap-2">
            <span>🛒</span>
