...
export default function Page() {
  ...
  return (
    <>
      ...
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 p-8">
        <div className="bg-gray-700 shadow-xl rounded-lg p-6 hover:shadow-2xl transition-shadow transform hover:scale-105">
          <h2 className="text-lg font-semibold text-gray-300 mb-2">Book 1</h2>
          <h3 className="text-xl font-bold text-white mb-4">REPOSITION OF CHRIST</h3>
          <Image src="/images/rep.jpg" alt="REPOSITION OF CHRIST" width={200} height={300} className="mx-auto mb-4 rounded" />
          <Link href="/reposition" className="text-blue-400 hover:text-blue-300 font-medium">Read more</Link>
          <p className="text-gray-300 mt-2"><b>Author:</b> Nathaneil C.U.Okoro</p>
          <p className="text-gray-300 mb-4">Price: ₦1000 (Soft Copy) | ₦1700 (Hard Copy)</p>
          <div className="flex gap-2">
            <button onClick={() => addToCart('REPOSITION OF CHRIST', 1000, 'Soft Copy')} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex-1">Buy Soft Copy</button>
            <button onClick={() => addToCart('REPOSITION OF CHRIST', 1700, 'Hard Copy')} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex-1">Buy Hard Copy</button>
          </div>
        </div>
