      ...
      <section id="books" className="container mx-auto py-12 md:py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-md">
            <Image src="/images/rep.jpg" alt="REPOSITION OF CHRIST" width={200} height={300} className="w-full rounded" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
          <Image src="/images/mypass.jpg" alt="DARE TO LIVE MY PASSION" width={200} height={300} className="w-full rounded" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
          <Image src="/images/nige.jpg" alt="NIGERIA ENTERPRISE" width={200} height={300} className="w-full rounded" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
          <Image src="/images/dare.jpg" alt="DARE TO SMILE IN THE DARKNESS OF LIFE" width={200} height={300} className="w-full rounded" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
          <Image src="/images/grasee (1).jpg" alt="GRASS TO GRACE" width={200} height={300} className="w-full rounded" />
