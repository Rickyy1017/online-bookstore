  ...
  const handleInfoSubmit = async () => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        'template_123456', // Replace with your EmailJS template ID
        {
          to_email: 'ericjo6303@gmail.com',
          from_email: email,
          phone: phone,
          message: `New contact: Email: ${email}, Phone: ${phone}`,
        },
        'your_public_key' // Replace with your EmailJS public key
      );

      // Send WhatsApp message (using a simple alert for demo, replace with actual WhatsApp API)
      alert(`WhatsApp message sent to +2349138246303: New contact - Email: ${email}, Phone: ${phone}`);
