...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setIsBannerVisible(true), 1000);
    const interval = setInterval(() => setIsBannerVisible(prev => !prev), 10000);
    return () => {
      clearTimeout(timer);
    ...
    <>
      ...
      <header className="text-center py-5">
        <h1 className="text-4xl text-gray-800 flex justify-center items-center">
          <Image src="/logo.png" alt="" width={130} height={160} className="mr-4" />
          UNUSUAL USUAL MAN
        </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 p-5">
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/rep.jpg" alt="" width={200} height={300} className="mx-auto" />
        ...
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/mypass.jpg" alt="" width={200} height={300} className="mx-auto" />
        ...
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/nige.jpg" alt="" width={200} height={300} className="mx-auto" />
        ...
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/dare.jpg" alt="" width={200} height={300} className="mx-auto" />
        ...
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/grasee (1).jpg" alt="" width={200} height={300} className="mx-auto" />
        ...
        <div className="bg-white shadow-lg rounded p-5">
          ...
          <Image src="/dark.png" alt="" width={200} height={300} className="mx-auto" />
      ...
      <div className="flex justify-center gap-5 mb-5">
        <Image src="/daycare1.png" alt="" width={300} height={200} />
        <Image src="/daycare2.jpg" alt="" width={300} height={200} />
      </div>
