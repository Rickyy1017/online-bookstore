      ...
      <section id="books" className="container mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
            <Image src="/images/rep.jpg" alt="REPOSITION OF CHRIST" width={200} height={300} className="mx-auto mb-6 rounded" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          <Image src="/images/dark.png" alt="DARKNESS AT NOONDAY DARE TO CHANGE THE SCRIPT" width={250} height={350} className="mx-auto mb-6 rounded" />
