  ...
  return (
    <>
      <nav className="bg-blue-900 flex justify-center py-2">
        <Link href="/" className="text-white mx-2 font-bold text-sm no-underline hover:underline">Home</Link>
        <Link href="/services" className="text-white mx-2 font-bold text-sm no-underline hover:underline">Services</Link>
        <Link href="/humanitarian-initiative" className="text-white mx-2 font-bold text-sm no-underline hover:underline">Humanitarian Initiative</Link>
        <Link href="/about" className="text-white mx-2 font-bold text-sm no-underline hover:underline">About Us</Link>
        <Link href="/contact" className="text-white mx-2 font-bold text-sm no-underline hover:underline">Contact</Link>
      </nav>
